...
# Create blueprint
api_snmp_bp = Blueprint('api_snmp', __name__)
...
@api_snmp_bp.route('/get', methods=['POST'])
@auth.login_required
def snmp_get():
    """
...
@api_snmp_bp.route('/bulk-get', methods=['POST'])
@auth.login_required
def snmp_bulk_get():
    """
...
@api_snmp_bp.route('/test-connection', methods=['POST'])
@auth.login_required
...
@api_snmp_bp.route('/info', methods=['GET'])
def snmp_info():
    """
